...
export default function ExperienceSteps() {
  ...
  return (
    <section className="py-20 bg-[#f9fafb] text-[#111827] dark:bg-gray-800 dark:text-white relative transition-colors duration-300">
      {/* Background pattern only in dark mode */}
      <div className="absolute inset-0 opacity-5 dark:opacity-5 hidden dark:block">
        <div
