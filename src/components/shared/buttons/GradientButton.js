...
export default function GradientButton({ type = 'button', children, disabled = false }) {
  return (
    <button
      type={type}
      disabled={disabled}
      className="group relative inline-flex items-center justify-center w-full px-12 py-4 text-lg font-semibold
